...
export default function Home() {
  ...
  return (
    <main className=" h-[80%] items-center mt-[3%] ">
      <h2 className="text-center text-2xl py-10 ">please fill this form</h2>
      <div className="bg-slate-700 p-8 rounded-md shadow-md sm:max-w-sm items-center justify-center py-20">

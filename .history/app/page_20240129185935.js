...
export default function Home() {
  ...
  return (
<main className="h-[80%] items-center mt-8">
  <h2 className="text-center text-2xl py-6">Please fill out this form</h2>
  <div className="bg-slate-700 p-8 rounded-md shadow-md sm:max-w-sm w-full max-w-md items-center justify-center py-12">

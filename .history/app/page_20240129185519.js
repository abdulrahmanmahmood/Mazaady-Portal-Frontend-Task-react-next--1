...
export default function Home() {
  ...
  return (
    <main className=" h-[80%] items-center mt-[20%] ">
      <h2 className="text-center text-2xl py-3 ">please fill this form</h2>
      <div className="bg-slate-700 p-8 rounded-md shadow-md w-full   py-20">

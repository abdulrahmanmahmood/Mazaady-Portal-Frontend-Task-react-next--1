...
export default function Home() {
  ...
  return (
    <main className=" h-screen items-center mt-3">
      <h2 className="text-center text-2xl p-3">please fill this form</h2>
      <div className="bg-slate-700 p-8 rounded-md shadow-md w-full ">
          ...
          <>
            {selectedProperty && selectedProperty.value === "other" && (
              <input
                ...
                className="mt-1 w-[250px] rounded-md border-red-600 shadow-sm  p-3"
              />
            )}
            {/* ... (your existing code) */}
          </>

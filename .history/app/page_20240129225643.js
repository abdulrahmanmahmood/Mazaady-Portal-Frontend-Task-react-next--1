    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg">
        ...
        <MainForm
          ...
          onMainChange={handleChange} {/* Change the prop name here */}
          onChildChange={handleChildChange} {/* Add new prop for child change */}
          onPropertyChange={handlePropertyChange} {/* Add new prop for property change */}
